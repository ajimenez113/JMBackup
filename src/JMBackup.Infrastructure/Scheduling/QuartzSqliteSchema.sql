-- Esquema oficial de Quartz.NET para SQLite (ADR-011), tomado de
-- https://github.com/quartznet/quartznet/blob/main/database/tables/tables_sqlite.sql
-- sin los DROP TABLE del original: este script solo se ejecuta cuando QRTZ_JOB_DETAILS
-- no existe todavía (ver QuartzSchemaInitializer), así que borrar antes de crear
-- borraría disparadores reales en cualquier ejecución futura por error.
